...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        long tiempoTotal= endtime-startime;
        System.out.println("Time taken: " + (tiempoTotal/1000000000.0) + " s");

        startime = System.nanoTime();
        System.out.println(fibonacciWithCaching(40));
        endtime = System.nanoTime();
        tiempoTotal= endtime-startime;
        System.out.println("Time taken: " + (tiempoTotal/1000000000.0) + " s");

        startime = System.nanoTime();
        System.out.println(fibonacciCaching(40));
        endtime = System.nanoTime();
        long tiempoTotal2= endtime-startime;
